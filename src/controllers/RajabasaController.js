...
const { connectionRajabasa } = require("../config/Database.js");
const {
  getDataBulan,
  handleAddBulanan,
  getDataHarian,
...
const dataKlinik = [
  {
    nama: "Klinik Kosasih Rawap Inap Rajabasa",
    id: 7,
    akun: "",
    jnsAkun: "Klinik",
  },
  {
    nama: "Laboratorium Kosasih Rajabasa",
    id: 8,
    akun: "",
    jnsAkun: "Lab",
  },
  ...
  try {
    ...
    const promises = dataKlinik.map(async (klinik) => {
      ...
      const response = await fetch.default(
        `http://202.157.189.177/:5005/rajabasa/pendapatan/${klinik.akun}`
      );
