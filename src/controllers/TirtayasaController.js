...
const { connectionTirtayasa } = require("../config/Database.js");
const {
  getDataBulan,
  getDataHarian,
  handleAddBulanan,
...
const dataKlinik = [
  {
    nama: "Klinik Pratama Kosasih Tirtayasa",
    id: 15,
    akun: "",
    jnsAkun: "Klinik",
  },
  {
    nama: "Laboratorium Kosasih Tirtayasa",
    id: 16,
    akun: "",
    jnsAkun: "Lab",
  },
  ...
  try {
    ...
    const promises = dataKlinik.map(async (klinik) => {
      ...
      const response = await fetch(
        `http://localhost:5005/tirtayasa/pendapatan/${klinik.akun}`
      );
